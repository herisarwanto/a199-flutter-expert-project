...
import 'package:ditonton/presentation/provider/botnav_bar_notifier.dart';
...
void init() {
  ...
  // locator.registerLazySingleton(() => BottomNavigationBarNotifier(locator()));
